...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayrollApplication.Entity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayrollApplication.Entity.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("HourseWorked")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("PayrollApplication.Entity.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayrollApplication.Entity.PaymentRecord", b =>
                {
                    b.HasOne("PayrollApplication.Entity.Employee", "Employee")
                        .WithMany("PaymentRecords")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PayrollApplication.Entity.TaxYear", "TaxYear")
                        .WithMany()
